...
class ServiceSubcategoryScreen extends StatefulWidget {
  static String routeName = './ServiceSubcategoryScreen';

  const ServiceSubcategoryScreen({super.key});

  @override
  State<ServiceSubcategoryScreen> createState() =>
      _ServiceSubcategoryScreenState();
}

class _ServiceSubcategoryScreenState extends State<ServiceSubcategoryScreen> {
  @override
  void initState() {
    super.initState();
  }
