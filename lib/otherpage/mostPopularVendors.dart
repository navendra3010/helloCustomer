...
class MostPopularVendorsScreen extends StatefulWidget {
  static String routeName = './MostPopularVendorsScreen';

  const MostPopularVendorsScreen({super.key});

  @override
  State<MostPopularVendorsScreen> createState() =>
      _MostPopularVendorsScreenState();
}

class _MostPopularVendorsScreenState extends State<MostPopularVendorsScreen> {
  @override
  void initState() {
    super.initState();
  }
